          ...
          {paquetesFiltrados.map((paquete, index) => {
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-3 sm:p-5 transform hover:-translate-y-1 border cursor-pointer relative ${esDelHotelReservado
              ...
              >
                ...
                <button
                  ...
                  className={`absolute top-2 sm:top-3 right-2 sm:right-3 p-1.5 sm:p-2 rounded-full transition-all duration-200 hover:scale-110 z-10 ${esFavorito
                ...
                <div className="flex gap-1 sm:gap-2">
                  <button
                    ...
                    className={`flex-1 px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl transition-all duration-200 font-semibold shadow-md hover:shadow-lg transform hover:scale-105 text-xs sm:text-sm ${esDelHotelReservado
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
                    ...
                    <button
                      ...
                      className={`px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base ${favoritos.some((fav) => fav.id_paquete === paqueteSeleccionado.id_paquete)
                        ? "bg-red-500 hover:bg-red-600 text-white"
                        : "bg-slate-200 hover:bg-slate-300 text-slate-700"
                        }`}
                    >
                      <Heart
                        className={`w-4 h-4 ${favoritos.some((fav) => fav.id_paquete === paqueteSeleccionado.id_paquete)
                          ? "fill-current"
                          : ""
                          }`}
                      />
